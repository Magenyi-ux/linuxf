...
/**
 * ChatMessage - Individual message component optimized with React.memo
 * This prevents all previous messages from re-rendering when a new message
 * is added or during AI response streaming.
 */
