...
/**
 * ChatMessage - Memoized component for individual chat bubbles.
 * Prevents re-rendering existing messages in the history when new messages are added
 * or when a message is being streamed.
 */
