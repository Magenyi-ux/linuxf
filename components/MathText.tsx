      ...
      {parts.map((part, i) => {
        if ((part.startsWith('$') && part.endsWith('$')) || (part.startsWith('\\(') && part.endsWith('\\)'))) {
          ...
          try {
            ...
            // 🛡️ Sentinel: Sanitize KaTeX output to prevent XSS if math strings are user-controlled.
            // Using profiles for SVG and MathML to preserve KaTeX rendering and accessibility.
